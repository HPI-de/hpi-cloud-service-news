...
@Api(
    ...
    canonicalName = "News",
    version = "v1test",
    title = "HPI Cloud News API",
    description = "An API providing news from HPI and HPImgzn.",
    namespace = ApiNamespace(
        ownerDomain = "cloud.hpi.de",
        ownerName = "HPI Cloud",
        packagePath = ""
    )
)
    ...
    companion object {
        ...
        val articles = listOf(
            ...
            Article(
                ...
                publishDate = DateAndTime.parseRfc3339String("2019-02-15'T'18:49:08Z"),
                thumbnail = URL("https://hpimgzn.de/wp-content/uploads/2018/12/photo_2018-12-16_20-19-43.jpg"),
                description = "Am 16.12 hat der Nachhaltigkeitsklub seinen ersten Workshop angeboten. Von Bokashianlagenbau bis hin zur Herstellung selbstgemachter Weihnachtsgeschenke. Lest hier mehr.",
                authorIds = listOf("1"),
                content = """
                    ...
                    """.trimIndent(),
                tags = listOf(
                    Tag(id = "1", name = "Nachhaltigkeitsklub", articleCount = 5),
                    Tag(id = "2", name = "Essen", articleCount = 1),
                    Tag(id = "3", name = "selbstgemacht", articleCount = 2)
                ),
                viewCount = 59
            )
        )
        ...
        val authors = listOf(
            Author(
                ...
                personId = "1",
                site = Site.HPI_MGZN,
                link = URL("https://hpimgzn.de/author/lilith-diringer/"),
                description = "",
                postCount = 7,
                commentCount = 0
            )
